...
export async function POST(req) {
    ...
    try {
        ...
        const { grandTotal, totalAmount, subtotal, splitCount, baseOrderId, restaurantId, notes } = body;
        ...
        // --- START FIX: Use notes from the body if they exist ---
        const finalNotes = notes || {};
        const splitIdFromNotes = finalNotes.split_session_id;
        // --- END FIX ---
